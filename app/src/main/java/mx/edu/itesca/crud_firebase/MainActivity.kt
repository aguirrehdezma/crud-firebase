package mx.edu.itesca.crud_firebase
...
import mx.edu.itesca.crud_firebase.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun setupRecyclerView(listaTareas: List<Tarea>) {
            adapter = TareaAdapter(listaTareas, ::borrarTareas, ::actualizarTarea)
